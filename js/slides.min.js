...
$(window).on("load", function () {
  ...
  $(document).ready(function () {
      ...
      if (
        ...
        m(),
          ...
          window.loaded &&
            ((window.blockScroll = 1),
            setTimeout(function () {
              d !== a && c.removeClass("active animate"),
                (window.blockScroll = 0);
            }, window.effectSpeed),
    ...
    if (
      ...
      var o = [];
      $("*").each(function () {
        "none" !== $(this).css("background-image")
          ? o.push(
              $(this)
          ...
          : $(this).is("img") && o.push($(this).attr("src"));
      }),
      ...
      (window.changeSlide = function (a) {
        if (
          ...
          var b = $(".slide:eq(" + (window.stage - 1) + ")"),
            c = $(b).offset().top;
          $("html,body").stop().clearQueue().animate({ scrollTop: c }, 1e3);
        } else if (
          a !== window.stage &&
          a <= window.stages &&
          1 !== window.inAction
        ...
        if (
          ...
          if (f.length > 0) {
            var h = $(f).attr("data-src"),
              j = h.indexOf("?") > -1 ? "&" : "?";
            $(f).attr("data-src", h + j + "autoplay=1");
        ...
        (c.hasClass("clickable") || c.hasClass("autoplay")) &&
          c.on("click next", function (a) {
            ...
            "cancel" != $(i).data("slider-event") &&
              ...
              window.sliderStatus &&
                $html
                  .removeClassByPrefix("slider_" + f)
                  .addClass("slider_" + f + "_" + e),
              h &&
                (b.addClass("animateOnEvent"),
                b.find("li").removeClassByPrefix("ae-").removeClass("do"),
                b.find(".selected").each(function (a) {
                  $(this)
                    .removeClassByPrefix("ae-")
                    .removeClass("do")
                    .addClass("ae-" + (a + 1))
              ...
              f &&
                g.length > 0 &&
                (g.children(".selected").removeClass("selected"),
                g.children("li:eq(" + e + ")").addClass("selected")));
          });
      });
    var y = $(".controller");
    if (y.length > 0) {
      var z = y.data("controller-selector")
        ? y.data("controller-selector")
        : "li";
      y.on("click", z, function () {
        ...
        a.hasClass("selected") ||
          ...
          f.children("li").eq(d).removeClass("hide").addClass("selected"),
          window.sliderStatus &&
            $html
              .removeClassByPrefix("slider_" + sliderID)
              .addClass("slider_" + sliderID + "_" + d)),
          g &&
            (f.addClass("animateOnEvent"),
            f.find(">li").removeClassByPrefix("ae-").removeClass("do"),
            f.find(".selected").each(function (a) {
              $(this)
                .removeClassByPrefix("ae-")
                .removeClass("do")
                .addClass("ae-" + (a + 1))
